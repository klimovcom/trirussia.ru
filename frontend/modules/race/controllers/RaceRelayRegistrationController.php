    ...
    public function actionDelete() {
        ...
        if ($user_id == $first_registration->user_id) {
            ...
            if ($raceRegistration->is_first == 1) {
                $registrationToDelete = RaceRelayRegistration::find()->where(['race_id' => $race_id, 'distance_id' => $distance_id, 'group' => $group])->andWhere(['not', ['user_id' => $raceRegistration->user_id]])->all();
