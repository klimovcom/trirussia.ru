                            ...
                            case Race::REGISTER_STATUS_OPEN :
                                if ($is_registered) {
                                    ...
                                    if (Yii::$app->user->isGuest) {
                                        ...
                                        echo Html::a('Зарегистрироваться', 'javascript:;',['class' => 'underline race-register', 'data-race-id' => $race->id, 'data-distance_id' => $raceDistance->distance_id, 'data-type' => $raceDistance->type]);
                                    }
                                }
                                break;
