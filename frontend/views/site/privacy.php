<div class="container">
    <h1 class="m-t-3 m-b-3">Условия пользования сайтом</h1>
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-8">
            <div class="card card-block">
                <p>К сожалению, по требованию социальных сетей мы обязаны указать условия пользования сайтом. По-русски эти условия звучат следующим образом: если вы пользуетесь сайтом, вы согласны, что мы используем куки, а также храним и обрабатываем данные, которые в указываете на сайте.
                </p>
                <p>In English:
                </p>
                <p>We use technologies like cookies (small files stored by your browser), web beacons, or unique device identifiers to anonymously identify your computer or device so we can deliver a better experience. Our systems also log information like your browser, operating system and IP address. We do not collect personally identifiable information about you. In other words, we do not collect information such as your name, address, phone number or email address. We do not knowingly contact or collect personal information from children under 13. If you believe we have inadvertently collected such information, please contact us so we can promptly obtain parental consent or remove the information.
                </p>
                <p>To customize our service for you, we and our partners may collect, use, and share precise location data, including the real-time geographic location of your computer or device. This location data is collected anonymously in a form that does not personally identify you and is used only to provide and improve our service. We may obtain your consent on your first use of the service.
                </p>
                <p>You can sign into your account to see any personally identifiable information we have stored, such as your name, email, address or phone number. You can also contact us by email to request to see this information. We may keep data indefinitely. We generally do not share personally identifiable information (such as name, address, email or phone) with other companies for marketing purposes.
                </p>
                <p>Ad companies may use and collect anonymous data about your interests to customize content and advertising here and in other sites and applications. Interest and location data may be linked to your device, but is not linked to your identity. If you have any questions or concerns about our privacy policies, please contact us.
                </p>
